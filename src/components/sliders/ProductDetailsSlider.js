      ...
      >
        <div className="product-img">
          <a href="assets/images/shop/product-big-1.jpg" className="img-popup">
            <img src="assets/images/shop/product-big-1.jpg" alt="Product" />
          </a>
        </div>
        <div className="product-img">
          <a href="assets/images/shop/product-big-2.jpg" className="img-popup">
            <img src="assets/images/shop/product-big-2.jpg" alt="Product" />
          </a>
        </div>
        <div className="product-img">
          <a href="assets/images/shop/product-big-3.jpg" className="img-popup">
            <img src="assets/images/shop/product-big-3.jpg" alt="Product" />
          </a>
        </div>
        <div className="product-img">
          <a href="assets/images/shop/product-big-2.jpg" className="img-popup">
