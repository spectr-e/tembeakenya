...
const Index = () => {
  return (
    <Layout header={1} noFooter>
                ...
                <div className="row align-items-center">
                  <div className="col-xl-6">
                    ...
                    <div className="hero-content text-white">
                      <h1 data-animation="fadeInDown" data-delay=".4s">
                        Welcome <br></br> enjoy the city
                      </h1>
                      <div className="text-button d-flex align-items-center">
                        <p data-animation="fadeInLeft" data-delay=".5s">
                          Welcome to the city of cool waters and fresh vibes!
                          Interact with the beautiful landscapes and the once in
                          a lifetime sunsets.
                        </p>
                        {/* <div
                  ...
                  <div className="col-xl-6">
                    ...
                    <div className="hero-image" data-animation="fadeInRight">
                      <img
                        src="assets/images/nairobi/nairobi night.jpg"
                        alt="Hero Image"
                      />
                    </div>
                  </div>
              ...
              <div className="container-fluid">
                <div className="row align-items-center">
                  ...
                  <div className="col-xl-6">
                    ...
                    <div className="hero-image" data-animation="fadeInRight">
                      <img
                        src="assets/images/nairobi/nairobi wild.jpg"
                        alt="Hero Image"
                      />
                    </div>
                  </div>
      ...
      {/*====== End Hero Section ======*/}
      {/*====== Start About Section ======*/}
      <section id="alerts" className="about-section pt-100">
        <div className="container-fluid">
            ...
            <div className="col-xl-6 col-lg-9">
              ...
              <div className="about-content-box text-center mb-55 wow fadeInDown">
                <div className="section-title mb-30">
                  <span className="sub-title">Weather Alerts</span>
                  <h2>A 5-day Weather Forecast in Nairobi.</h2>
                </div>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde
                  aspernatur nam recusandae itaque alias tempora esse et illum,
                  earum fugit facilis. Nostrum sint voluptatibus voluptates
                  placeat esse. Dolorem, obcaecati ratione. Lorem ipsum dolor
                  sit amet, consectetur adipisicing elit. Vero reiciendis dolor
                  natus nobis dolorum.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="single-features-item mb-40">
              <div className="img-holder">
                <img
                  src="assets/images/nairobi/weather-1.jpg"
                  alt="Features Image"
                />
                <div className="content">
                  <div className="text">
                    <h4 className="title">Mon: Sunny 100°C</h4>
                    <a href="#" className="icon-btn">
                      <i className="far fa-arrow-right" />
                    </a>
                  </div>
                  <p>Set unde omnis kiwarambe voluptatem aperiae.</p>
                </div>
              </div>
            </div>
            {/*=== Features Image Item ===*/}
            <div className="single-features-item mb-40">
              <div className="img-holder">
                <img
                  src="assets/images/nairobi/weather-2.jpg"
                  alt="Features Image"
                />
                <div className="content">
                  <div className="text">
                    <h4 className="title">Tue: Light Rain 18°C</h4>
                    <a href="#" className="icon-btn">
                      <i className="far fa-arrow-right" />
                    </a>
                  </div>
            ...
            <div className="single-features-item mb-40">
              <div className="img-holder">
                <img
                  src="assets/images/nairobi/weather-3.jpg"
                  alt="Features Image"
                />
                <div className="content">
                  <div className="text">
                    <h4 className="title">Wed: Storm 10°C</h4>
                    <a href="#" className="icon-btn">
                      <i className="far fa-arrow-right" />
                    </a>
                  </div>
            ...
            <div className="single-features-item mb-40">
              <div className="img-holder">
                <img
                  src="assets/images/nairobi/weather-4.jpg"
                  alt="Features Image"
                />
                <div className="content">
                  <div className="text">
                    <h4 className="title">Thur: Winter 9°C</h4>
                    <a href="#" className="icon-btn">
                      <i className="far fa-arrow-right" />
                    </a>
                  </div>
            ...
            <div className="single-features-item mb-40">
              <div className="img-holder">
                <img
                  src="assets/images/nairobi/weather-5.jpg"
                  alt="Features Image"
                />
                <div className="content">
                  <div className="text">
                    <h4 className="title">Fri : Hot Sun 50°</h4>
                    <a href="#" className="icon-btn">
                      <i className="far fa-arrow-right" />
                    </a>
                  </div>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
              ...
              <div className="section-title text-center mb-60 wow fadeInDown">
                ...
                <h2>Amazing Services You Will Have Access To</h2>
              </div>
            </div>
          </div>
          {/* <Slider
          ...
          <div className="row justify-content-center">
            <div className="col-xl-8">
              ...
              <div className="section-title text-center mb-50 wow fadeInDown">
                ...
                <h2>What People Say About Our Smart City</h2>
              </div>
            </div>
          </div>
          <div className="row align-items-xl-center">
